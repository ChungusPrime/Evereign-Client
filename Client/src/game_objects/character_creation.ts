...
export default class CharacterCreation extends Phaser.GameObjects.Container {
  ...
  constructor ( scene: Menu, x: number, y: number ) {
    ...
    this.ClassScreenHeader = scene.add.text(10, 10, "Choose Class", { align: "center", fontSize: "36px", fontFamily: "Mooli" }).setOrigin(0);
    this.ClassOptionsList = scene.add.rectangle(5, 5, this.scene.scale.width * 0.4, this.scene.scale.height * 0.8, 0x000000, 0.8).setOrigin(0);
    ...
    this.RaceScreenHeader = scene.add.text(10, 10, "Choose Race", { align: "center", fontSize: "36px", fontFamily: "Mooli" }).setOrigin(0);
    this.RaceOptionsList = scene.add.rectangle(5, 5, this.scene.scale.width * 0.4, this.scene.scale.height * 0.8, 0x000000, 0.8).setOrigin(0);
    ...
    this.FactionScreenHeader = scene.add.text(10, 10, "Choose Faction", { align: "center", fontSize: "36px", fontFamily: "Mooli"  }).setOrigin(0);
    this.FactionOptionsList = scene.add.rectangle(5, 5, this.scene.scale.width * 0.4, this.scene.scale.height * 0.8, 0x000000, 0.8).setOrigin(0);
    ...
    this.AttributePointsRemainingText = scene.add.text(10, this.AttributeHeader.getBottomCenter().y + 10, `Points Left: ${this.AttributePoints}`, { align: "center", fontSize: "20px", fontFamily: "Mooli" }).setOrigin(0);
    this.AttributeOptions = scene.add.rectangle(5, 5, this.scene.scale.width * 0.4, this.scene.scale.height * 0.8, 0x000000, 0.8).setOrigin(0);
    ...
    this.OptionDescriptionBackground = scene.add.rectangle(this.ClassOptionsList.getTopRight().x + 10, 5, this.scene.scale.width * 0.4, this.scene.scale.height * 0.8, 0x000000, 0.8).setOrigin(0);
    this.OptionDescriptionText = scene.add.text(this.ClassOptionsList.getTopRight().x + 15, 10, "", { align: "left", fontSize: 13, fontFamily: "Mooli", wordWrap: { width: this.scene.scale.width * 0.4 - 10, useAdvancedWrap: true } }).setOrigin(0);
  ...
  setOptions () {
    ...
    this.scene.Classes.forEach(v => {
      const text = new Text(this.scene, 10, ClassY, v.name, 24, false);
      text.on('pointerdown', () => {
    ...
    this.scene.Races.forEach(v => {
      const text = new Text(this.scene, 10, RaceY, v.name, 24, false);
      text.on('pointerdown', () => {
    ...
    this.scene.Factions.forEach(v => {
      const text = new Text(this.scene, 10, FactionY, v.name, 24, false);
      text.on('pointerdown', () => {
