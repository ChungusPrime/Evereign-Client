...
export default class NPC extends Phaser.Physics.Arcade.Sprite {
  ...
  constructor( scene, npc ) {
    ...
    this.name_plate = scene.add.text(this.x, this.y - 65, npc.name, { fontSize: "14px", fill: "#ffffff" }).setOrigin(0.5);
  ...
  update() {
    ...
    if ( this.target == null ) {
      if ( Phaser.Geom.Rectangle.Overlaps(this.scene.player.getBounds(), this.aggro_area.getBounds()) && this.scene.player.faction != this.faction ) 
